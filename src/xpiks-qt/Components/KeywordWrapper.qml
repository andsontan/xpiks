...
Rectangle {
    ...
    color: isHighlighted ? Colors.inputForegroundColor : Colors.inactiveControlColor
    ...
    Row {
        ...
        Item {
            ...
            StyledText {
                ...
                color: itemWrapper.isHighlighted ? Colors.inactiveControlColor : Colors.labelActiveForeground
